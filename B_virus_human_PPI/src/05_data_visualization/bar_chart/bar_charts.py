...
data_folder = "src/05_data_visualization/bar_chart/input_folder_bar_chart"
use_counts = True
txt_paths = []
...
plt = create_multi_row_pie_charts(txt_paths, classification_mapping, use_counts)
plt.savefig(os.path.join(data_folder, 'bar_chart.png'), bbox_inches='tight')