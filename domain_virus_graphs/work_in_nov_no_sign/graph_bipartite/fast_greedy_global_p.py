...
output_file1 = "local_code\\graph_bipartite\\results\\fast_greedy\\laplacian_global.txt"
...
output_file2 = "local_code\\graph_bipartite\\results\\fast_greedy\\normalized_global.txt"

compare_original_with_random(
    original_path=original_network1,
    random_folder=random_networks_folder1,
    output_file=output_file1,
    algorithm=lambda g: g.community_fastgreedy(weights=g.es["normalized_weight"]).as_clustering(),
)
