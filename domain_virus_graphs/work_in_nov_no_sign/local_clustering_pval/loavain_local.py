...
output_file1 = "local_code\local_clustering_pval/louvain_laplacian_unique_pairs.txt"
...
output_file2 = "local_code\local_clustering_pval/louvain_normalized_unique_pairs.txt"

# Define the clustering algorithm
algorithm = lambda g: g.community_multilevel(weights=g.es["normalized_weight"])
