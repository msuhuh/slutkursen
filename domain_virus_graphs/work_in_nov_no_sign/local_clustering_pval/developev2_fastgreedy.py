...
def compare_original_with_random_clusters(original_path, random_folder, output_file, algorithm):
    ...
    original_pairs, original_N_clusters = get_cluster_pairs(original_g, algorithm)
...
output_file2 = "local_code\local_clustering_pval/normalized_unique_pairs.txt"

# Define the clustering algorithm
algorithm = lambda g: g.community_fastgreedy(weights=g.es["normalized_weight"])
