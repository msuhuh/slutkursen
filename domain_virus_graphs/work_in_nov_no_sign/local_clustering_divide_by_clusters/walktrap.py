...
def get_cluster_pairs(graph, clusters=None):
    communities = graph.community_walktrap(weights=graph.es["normalized_weight"]).as_clustering()
    cluster_pairs = set()
...
output_file1_base = "local_code/local_clustering_divide_by_clusters/results/walktrap_laplacian"
...
output_file2_base = "local_code/local_clustering_divide_by_clusters/results/walktrap_norm"
