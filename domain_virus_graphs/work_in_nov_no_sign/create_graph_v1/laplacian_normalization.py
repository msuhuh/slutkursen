...
graph = Graph.Read_Ncol(r"local_code\create_graph_v1\data_graphs\graph_0_1_v1.txt", weights=True, directed=False)
...
with open(r"local_code\create_graph_v1\data_graphs\laplacian_normalized_edge_weights.txt", "w") as file:
